...
char test_local_load_char() {
    char local;
    local = 55;
    return local;         /* Should: ld a, (iy-N) */
}

int test_local_load_int() {
    int local;
    local = 777;
    return local;         /* Should: ld hl, (iy-N) */
}

long test_local_load_long() {
    long local;
    local = 11111L;
...
void test_register_allocated(int a, int b) {
    int result;
...
void test_multiple_args(char c1, char c2, int i1, int i2, long l1, long l2) {
