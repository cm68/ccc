...
int opdope[] = {
	...
	/*
	 * 30: INCBEF 
	 */ PREC(PREC_UNARY) | PCVOK | RASSOC | LVALUE | BINARY,
	/*
	 * 31: DECBEF 
	 */ PREC(PREC_UNARY) | PCVOK | RASSOC | LVALUE | BINARY,
	/*
	 * 32: INCAFT 
	 */ PREC(PREC_POSTFX) | PCVOK | LVALUE | BINARY,
	/*
	 * 33: DECAFT 
	 */ PREC(PREC_POSTFX) | PCVOK | LVALUE | BINARY,
	/*
	 * 34: EXCLA 
	 */ PREC(PREC_UNARY) | RASSOC,
	/*
	 * 35: AMPER 
	 */ PREC(PREC_UNARY) | RASSOC | LVALUE,
	/*
	 * 36: STAR 
	 */ PREC(PREC_UNARY) | RASSOC | LWORD,
	/*
	 * 37: NEG 
	 */ PREC(PREC_UNARY) | RASSOC,
	/*
	...
	/*
	 * 40: PLUS 
	 */ PREC(PREC_ADD) | PCVOK | COMMUTE | BINARY,
	/*
	 * 41: MINUS 
	 */ PREC(PREC_ADD) | PCVOK | BINARY,
	/*
	 * 42: TIMES 
	...
	/*
	 * 53: LOGAND 
	 */ PREC(PREC_LAND) | BINARY,
	/*
	 * 54: LOGOR 
	 */ PREC(PREC_LOR) | BINARY,
	/*
	 * 55: ANDN 
	...
	/*
	 * 70: ASPLUS 
	 */ PREC(PREC_ASGN) | PCVOK | RASSOC | ASSGOP | LVALUE | BINARY,
	/*
	 * 71: ASMINUS 
	 */ PREC(PREC_ASGN) | PCVOK | RASSOC | ASSGOP | LVALUE | BINARY,
	/*
...
char cvtab[4][4] = {
	 ...
	 * int double long ptr 
	 */
	{ 0, (FTI << 4) + ITF, (LTI << 4) + ITL, (ITP << 4) + ITP }, /* int */
	{ ITF, 0, LTF, XX },		/* dbl */
	{ ITL, (FTL << 4) + LTF, 0, (LTP << 4) + LTP },	/* long */
	{ ITP, XX, LTP, PTI }		/* ptr */
};
