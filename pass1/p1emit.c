 ...
 * 3: 01EC PMO +++
 **************************************************/
void emitDepVar(register sym_t *p) {
...
/**************************************************
 * 10: 0470 PMO +++
 * emitExprOrOne - Emit expression or "1" if null
 **************************************************/
void emitExprOrOne(expr_t *p) {
...
/**************************************************
 * 13: 05B5 PMO +++
 * emitExprLine - Emit expression with newline
 **************************************************/
...
/**************************************************
 * 14: 05D3 PMO +++
 * emitEnumValue - Emit enum constant value
 **************************************************/
...
/**************************************************
 * 15: 05F1 PMO +++
 * emitExprTree - Recursively emit expression tree
 **************************************************/
void emitExprTree(register expr_t *st) {
    op_t *po;
    sym_t *ps;
