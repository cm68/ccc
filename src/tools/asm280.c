...
/* the longest Z280 instruction is six bytes (a prefixed LDW with a
 * 16-bit address and a 16-bit immediate); leave room for eight */
static unsigned char lst_bytes[8];
