...
TESTS="while for do nested for_empty_incr empty_macro break continue switch_in_loop dowhile_nested mixed_loops multiline_for spill_while spill_for spill_nested spill_do funcptr"
